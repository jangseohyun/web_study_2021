...
<!-- 
	○ TestSession01에서 TestSession02로
	   이름과 생일을 입력받아 전송
	   TestSession02에서 TestSession03으로
	   아이디와 패스워드를 입력받고
	   앞에서 전달받은 이름과 생일을 함께 전송
	   TestSession03에서 전달받은 이름, 생일, 아이디, 패스워드 출력
	...
	<form action="TestSession02.jsp" method="post">
		<table>
			...
			<tr>
				<th>생일</th>
				<td>
					<input type="text" name="userBirth" style="width: 200px;">
				</td>
			</tr>
			<tr>
				<th colspan="2">

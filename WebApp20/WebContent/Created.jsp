...
<script type="text/javascript">
	...
	function sendIt()
	{
		...
		//    하지만 외부에서 참조한 util.js 파일에
		//    만들어 두었기 때문에 현재는 사용 가능.
...
<div id="bbs">
	...
	<form action="" method="post" name="myForm">
		<div id="bbsCreated">
			...
			<div class="bbsCreated bottomLine">
				<dl>
					<dt>이메일</dt>
					<dd>
						<input type="email" name="email" class="boxTF" size="35" maxlength="50">
					</dd>
				</dl>
			</div><!-- .bbsCreated_bottomLine -->
			...
			<div id="bbsCreated_noLine">
				<dl>
					<dt>패스워드</dt>
					<dd>
						<input type="password" name="pwd" class="boxTF" size="" maxlength="7">
						&nbsp;(게시물 수정 및 삭제 시 필요)
					</dd>
				</dl>
			...
			<div id="bbsCreated_footer">
				...
				<input type="reset" value="다시입력" class="btn2" onclick="document.myFrom.subject.focus();">
